...
# ----------------------------------------
# ACDS 18.1 625 linux 2020.10.11.15:30:04
...
alias file_copy {
  ...
  file copy -force $QSYS_SIMDIR/submodules/niosLab2_onchip_rom.hex ./
  file copy -force $QSYS_SIMDIR/submodules/niosLab2_onchip_ram.hex ./
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/niosLab2_onchip_rom.vhd"                                         -work onchip_rom                                  
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/niosLab2_onchip_ram.vhd"                                         -work onchip_ram                                  
