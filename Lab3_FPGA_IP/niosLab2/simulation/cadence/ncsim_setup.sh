...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  ...
  cp -f $QSYS_SIMDIR/submodules/niosLab2_onchip_rom.hex ./
  cp -f $QSYS_SIMDIR/submodules/niosLab2_onchip_ram.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/niosLab2_onchip_rom.vhd"                                         -work onchip_rom                                   -cdslib ./cds_libs/onchip_rom.cds.lib                                  
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/niosLab2_onchip_ram.vhd"                                         -work onchip_ram                                   -cdslib ./cds_libs/onchip_ram.cds.lib                                  
